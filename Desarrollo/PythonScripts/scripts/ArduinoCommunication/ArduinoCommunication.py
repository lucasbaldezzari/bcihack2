...
class ArduinoCommunication:
    ...
    def __init__(self, port, baudrate = 19200, commands = [b'1',b'2',b'3',b'4',b'5'], sleep = 1):
        """
        Constructor del objeto ArduinoCommunication
        ...
        self.sleep = sleep #tiempo de espera para establecer comunicación serie
        time.sleep(self.sleep*1000) #esperamos para establecer comunicación serie
    ...
    def iniSesion(self):
        ...
        self.estados = [str(self.systemControl[0])[2],str(self.systemControl[1])[2],self._estadoRobot]
