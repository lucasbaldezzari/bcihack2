...
from keras.layers import (Conv2D, BatchNormalization, ELU, AveragePooling2D,
                          ...
                          Activation, SeparableConv2D,MaxPooling2D,Flatten,Conv1D, MaxPooling1D, Flatten, Dense, Dropout)
...
class CRNN_EEGNet:
    ...
    def _build_model(self):
        ...
        # Primera capa convolucional con padding
        model = Sequential()
        model.add(Conv1D(filters=64, kernel_size=5, activation='relu', padding='same', input_shape=(6, 750)))
